export const DATA = [
  {
    ...
    products: [
      { product: "무빈소장례(가족장)", price: 0 },
      { product: "조문객 100명 미만", price: 71 },
      { product: "조문객 200명 미만", price: 84 },
      { product: "조문객 300명 미만", price: 99 },
      { product: "조문객 300명 이상", price: 116 },
    ],
...
export const PREORDER = [
  ...
  { title: "입관시 꽃관장식 서비스", content: "생화, 한지 꽃장식" },
